  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              >
                ...
                {/* YouTube Badge */}
                <div className="absolute top-4 right-4 bg-red-600 text-white px-3 py-1 rounded-md text-sm font-semibold flex items-center gap-2">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">WhatsApp Services Pricing</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
