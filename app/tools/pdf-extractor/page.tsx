...
// export default function PdfExtractorSignupPage() {
...
//             Create your account to unlock <span className="text-emerald-400">PDF Extractor</span>
//           </h1>
//           <p className="text-slate-300 text-sm md:text-base max-w-md">
//             Extract tables and key invoice data into clean Excel files in seconds. No credit card required for your 7-day free trial.
//           </p>
...
//     try {
//       const res = await fetch(`${API_BASE_URL}/api/pdf-auth/register`, {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({ name, email, password }),
//       });
