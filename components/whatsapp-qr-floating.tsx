...
export default function WhatsAppQRFloating() {
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <div className="fixed bottom-24 right-6 z-50">
          <Button
            className="bg-white hover:bg-gray-50 active:bg-gray-50 text-gray-700 border-2 border-green-500 rounded-full w-16 h-16 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 active:scale-110"
            size="lg"
          >
