        ...
        <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-md border-b border-green-100 z-50">
            <div className="container mx-auto px-4 lg:px-6 py-3 flex items-center justify-between gap-4">
                ...
                <div className="hidden md:flex items-center gap-4 lg:gap-6 xl:gap-8 flex-wrap">
                    <Link
                        href="/ai-agent"
                        className="flex items-center gap-1 text-green-600 font-medium hover:text-green-600 transition-colors whitespace-nowrap text-sm lg:text-base"
                    >
                        <Bot className="h-4 w-4" />
                        AI Agent
                    </Link>
                    ...
                    <Link 
                        href="/free-whatsapp-business-guide" 
                        className="text-green-600 font-medium transition-colors whitespace-nowrap text-sm lg:text-base"
                    >
                        Free Guide
                    </Link>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1 text-gray-700 hover:text-green-600 transition-colors font-medium whitespace-nowrap text-sm lg:text-base"
                    >
                        <User className="h-4 w-4" />
                        User
                    </a>
